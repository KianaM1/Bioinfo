...
FLAGS = --header : --colsep ',' -v --eta --halt now,fail=1 -j ${NCPU}
...
usage:
	...
	@echo "# Setup:"
	@echo "#"
	@echo "#    Your system must be set up as described in the Biostar Workflows book."
	@echo "#"
	@echo "#    https://www.biostarhandbook.com/books/workflows/help/install/"
	@echo "#"
...
# Shortcut to generating the design matrix.
design: ${DESIGN}
	ls -lh ${DESIGN}
